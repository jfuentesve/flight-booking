...
Run `http-server ./dist/flight-booking -p 8081` for a dev server. Navigate to `http://localhost:8081/main.js`. The app will automatically reload if you change any of the source files.
